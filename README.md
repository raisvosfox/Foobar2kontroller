...
- **Fullscreen Mode**: Automatically hides system bars in landscape for an immersive experience.
...
2. Ensure your Beefweb server is running and accessible on your local network.
3. Enter the server URL (e.g., `192.168.1.100:8880`) on the initial setup screen.

## Settings
Press the **Back button** while on the player screen to access the settings menu. From there, you can:
- Toggle playback controls.
- Update colors using Hex codes (e.g., `#2F4F4F` for slate grey).
